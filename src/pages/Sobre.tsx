      ...
      <section className={pageSectionClass}>
        <div className="mx-auto max-w-4xl space-y-6 text-center">
          <p className="section-copy">
            Há mais de duas décadas presente no mercado imobiliário carioca, a <strong>GranKasa</strong> se
            consolidou como referência em intermediação de compra, venda e locação de imóveis residenciais e
        ...
        <div className="mt-12 grid grid-cols-1 gap-7 items-start md:grid-cols-3">
          ...
          <aside className="surface-sidebar">
            ...
            <p className="section-copy-muted mt-2">
